               ...
               {(gig.status === "completed" && !gig.workStatus) && (
                ...
                <div className="mt-4 flex justify-between items-center border-t pt-2 text-sm">
                  <div className="flex items-center">
                    <p className="text-black font-normal text-sm mr-2">Gig has been completed by</p>
                    {gig.freelancerId && freelancers[gig.freelancerId] ? (
                      <div className="flex justify-center items-center gap-1">
                        ...
                        />
                        <p className="font-medium text-base">{freelancers[gig.freelancerId]?.name ?? "Unknown Freelancer"}</p>
                      </div>
                    ) : (
  ...
  <AlertDialogContent className="bg-white text-black">
    <AlertDialogHeader>
      ...
      <AlertDialogDescription>
        After approving the work of the freelancer you need to pay him.
      </AlertDialogDescription>
    </AlertDialogHeader>
    <AlertDialogFooter>
...
<div className="mt-4 flex justify-between items-center border-t pt-2 text-sm">
  <div className="flex items-center">
    <p className="text-black font-normal text-sm mr-2">Work by</p>
    {gig.freelancerId && freelancers[gig.freelancerId] ? (
      <div className="flex justify-center items-center gap-1">
        <img
          src={freelancers[gig.freelancerId]?.profilePicture || "/default-avatar.png"}
          ...
          className="w-8 h-8 rounded-full border border-gray-300"
        />
        <p className="font-medium text-base mr-1">{freelancers[gig.freelancerId]?.name ?? "Unknown Freelancer"}</p>
      </div>
    ) : (
      <p>No freelancer info</p>
  ...
  <div className="flex justify-center items-center">                  
    <Button className="bg-green-100 text-green-700 rounded" disabled={false}>
