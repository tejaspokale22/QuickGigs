          ...
          {freelancers.length === 0 ? (
            <div className="bg-white rounded shadow-sm p-8 text-center border border-gray-200">
              <p className="text-gray-600 text-lg">
                No freelancers have applied for this gig yet.
              </p>
            </div>
          ) : (
                    ...
                    <div className="flex items-center space-x-4 mb-3">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">
                          Best Match: {bestFreelancer.name}
                        </h3>
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        <th
                          scope="col"
                          className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-r border-gray-200"
                        >
                          Freelancer
                        </th>
                        <th
                              ...
                              <AlertDialogContent className="bg-white">
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription className="text-gray-600">
                                    ...
                                    {freelancer.name}? This action cannot be
                                    undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
