...
import { fetchUserChats } from '@/utils/actions/chatActions'
                  ...
                  {chats.map((chat) => (
                    ...
                    >
                      {chat.participants.map((participantId: string) => {
                        const user = participantsDetails.find(
                ...
                <div className="max-w-md text-center">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-sm text-gray-500">
                      <p>
                        Connect with other professionals and discuss
                        opportunities
                      </p>
                    </div>
                  </div>
