                ...
                <Tabs defaultValue="upi" className="w-full">
                  <TabsList className="grid w-full h-10 grid-cols-2 mb-6 p-1 bg-gray-50 rounded">
                    <TabsTrigger
                      value="upi"
                      onClick={() => setTab('upi')}
                      className="flex justify-center data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all duration-200"
                    >
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        {errorsBank.bankName?.message && (
                          <p className="text-red-500 text-sm mt-1.5">
                            {String(errorsBank.bankName.message)}
                          </p>
                        )}
                      </div>
                      <div className="space-y-2">
                        ...
                        {errorsBank.accountNumber?.message && (
                          <p className="text-red-500 text-sm mt-1.5">
                            {String(errorsBank.accountNumber.message)}
                          </p>
                        )}
                      </div>
                      <div className="space-y-2">
                        ...
                        {errorsBank.ifscCode?.message && (
                          <p className="text-red-500 text-sm mt-1.5">
                            {String(errorsBank.ifscCode.message)}
                          </p>
                        )}
                      </div>
                      <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Last project completed 2 days ago
            </p>
          </div>
            ...
            {paymentLoading ? (
              ...
              <div className="space-y-3">
                ...
                {paymentInfo.bankDetails &&
                  typeof paymentInfo.bankDetails.value === 'object' &&
                  'accountNo' in paymentInfo.bankDetails.value && (
                    <div className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            Account No:{' '}
                            {paymentInfo.bankDetails.value.accountNo}
                          </p>
