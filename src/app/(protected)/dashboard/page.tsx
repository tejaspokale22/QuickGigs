...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 pt-20 p-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          cursor-pointer bg-gray-50/50 hover:bg-gray-50"
            ...
            <div className="bg-linear-to-br from-gray-800 via-gray-900 to-black rounded-xl p-6 shadow-lg text-white border border-gray-700">
